...
public static class KTHTopDownPrototypeRecordingLauncher
{
    ...
    public static void Run()
    {
        ...
        {
            outputDir = Path.Combine(Directory.GetCurrentDirectory(), "outputs", "unity_recordings", "topdown_prototype_gaussian_runtime");
        }
    ...
    {
        GameObject recorderObject = new GameObject("KTH TopDown Prototype Play Recorder");
        KTHTopDownPrototypePlayRecorder recorder = recorderObject.AddComponent<KTHTopDownPrototypePlayRecorder>();
